...
// Cache the localhost requests with a stale-while-revalidate strategy.
// Mostrar lo que hay en cache mientras se revalida por si hay algo nuevo en la web
//        STALE    ---->           WHILE      ---->         REVALIDATE
registerRoute(
  /http:\/\/localhost*\/api*/,
  new StaleWhileRevalidate({
    cacheName: 'api_GET_calls',
  }),
  'GET',
);
